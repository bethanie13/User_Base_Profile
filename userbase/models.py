...
class User(db.Model, UserMixin):
    ...
    firstname = db.Column(db.String(20), nullable=False)  # think these unique for first/last name need to be false
    ...
    def __repr__(self):
        return f"User('{self.firstname}','{self.lastname}', '{self.department}','{self.email}', '{self.image_file}')"
